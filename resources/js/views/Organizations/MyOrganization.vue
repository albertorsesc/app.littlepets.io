<template>
    <div>
        <div v-if="! organization.hasOwnProperty('id')"
             class="items-center flex justify-start w-full"
             v-cloak>
...
<!--                            <div class="bg-gray-50 px-5 py-3">
                        ...
                        <div class="bg-white overflow-hidden shadow rounded-lg">
                            <div class="p-5">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <i class="fas fa-paw flex-shrink-0 text-base text-gray-400"></i>
                                    </div>
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium text-gray-500 truncate">
                                            ...
                                            <dd>
                                                <div class="text-lg font-medium text-gray-900" v-text="organization.adoptions.length"></div>
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
