...
{{--                                        v-text="headerTitle"--}}
                                        v-cloak
                                    >Explora Veterinarias</h1>
                                </div>
                                <dl class="mt-3 lg:mt-6 flex flex-col lg:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
                                    <dd class="flex items-center text-sm text-gray-500 font-medium capitalize sm:mr-6">
                                        <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 110 2h-3a1 1 0 01-1-1v-2a1 1 0 00-1-1H9a1 1 0 00-1 1v2a1 1 0 01-1 1H4a1 1 0 110-2V4zm3 1h2v2H7V5zm2 4H7v2h2V9zm2-4h2v2h-2V5zm2 4h-2v2h2V9z" clip-rule="evenodd" />
                                        </svg>
                                        Explora o Registra tu clinica veterinaria y deja que tus pacientes te encuentren!
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        <div class="md:flex lg:ml-24 items-center align-middle lg:-mb-8 lg:space-x-3 mt-3 lg:mt-0">
