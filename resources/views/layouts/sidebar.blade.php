            ...
            <nav class="mt-5 flex-1 flex flex-col divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
                ...
                <div class="px-2 space-y-1">
                    ...
                    <a href="{{ route('web.organizations.index') }}"
                       class="@if(request()->routeIs('web.organizations.index') || request()->segment(1) === 'organizaciones') bg-cyan-800 @endif text-white hover:text-white hover:bg-cyan-800 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-4 flex-shrink-0 text-cyan-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
